# Environment Context Switcher Tasks
...
9. `09-environment-aware-invoice-ksef-state.md` Status: `completed`
10. `10-environment-aware-correction-flow.md`
11. `11-environment-aware-incoming-sync.md`
12. `12-environment-aware-read-models-and-reports.md`
13. `13-ksef-action-safety-ux.md`
14. `14-environment-aware-test-coverage.md`
15. `15-legacy-cleanup-and-docs.md`
...
- `10-environment-aware-correction-flow.md`

## Source Spec
- `spec/environment-context-switcher-plan.md`
