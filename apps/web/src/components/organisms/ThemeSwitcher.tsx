...
export function ThemeSwitcher() {
  ...
  return (
    <button
      ...
      className="inline-flex min-h-11 min-w-11 items-center justify-center rounded-control border border-outline bg-chrome px-3 text-sm font-semibold text-foreground transition hover:bg-surface-raised focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary lg:h-8 lg:min-h-0 lg:w-8 lg:min-w-0"
    >
