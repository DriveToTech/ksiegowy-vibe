export const t = {
  ...
  household: {
    ...
    ledger: {
      ...
      filters: { all: "Wszystkie", in: "Wpływy", out: "Wydatki", recurring: "Cykliczne" },
      columns: {
        date: "Data",
        payee: "Odbiorca",
        category: "Kategoria",
    ...
    transactionForm: {
      ...
      applyRuleToFuture: "Zastosuj też do przyszłych płatności od tego odbiorcy",
      save: "Zapisz",
