export const t = {
  nav: {
    ...
    settings: "Ustawienia",
    more: "Więcej",
    mobileOverview: "Start",
    mobileOutgoingInvoices: "Sprzedaż",
    mobileIncomingInvoices: "Zakupy",
    mobileContractors: "Kontrahenci",
    mobileCompliance: "Raporty & JPK",
  },
  ...
  ksefSync: {
    ...
    productionConfirmTitle: "Potwierdź import z PRODUKCJI",
    productionConfirmDescription: (companyName: string) => `Import dla firmy „${companyName}” pobierze dane z produkcyjnego KSeF. Operacja może ujawnić rzeczywiste dokumenty i wywołać skutki operacyjne.`,
  ...
  invoicesTable: {
    ...
    paymentDraft: "SZKIC",
    paymentIssuing: "WYSTAWIANIE",
    paymentBlocked: "ZABLOKOWANA",
    ksefColumn: "KSeF",
    draftFallback: "Szkic",
    issuingFallback: "Wystawianie…",
  ...
  header: {
    ...
    environmentSwitching: "Zmieniam środowisko KSeF…",
    environmentChanged: (environment: string) => `Aktywne środowisko KSeF: ${environment}. Odświeżam dane.`,
    environmentPersistenceError: "Nie udało się zapisać środowiska KSeF w tej przeglądarce. Pozostawiono poprzednie środowisko.",
    environmentServerSavedBrowserError: "Środowisko zapisano na serwerze, ale nie udało się zapisać go w tej przeglądarce.",
    productionConfirmTitle: "Potwierdź środowisko produkcyjne",
    productionConfirmDescription: (companyName: string) => `Firma „${companyName}” zostanie przełączona na środowisko PRODUKCYJNE. Operacje KSeF dla tej firmy mogą wywołać skutki prawne i finansowe.`,
    productionConfirmCancel: "Anuluj",
    productionConfirmProceed: "Przełącz na PRODUKCJĘ",
  ...
  invoiceActions: {
    ...
    issuing: "Wystawianie…",
    issuanceInProgressTitle: "Wystawianie faktury jest w toku",
    issuanceInProgressDescription: "Odśwież status, aby sprawdzić wynik. Ponowna próba używa bezpiecznej blokady serwera i nie oznaczy faktury jako wystawionej bez poprawnych artefaktów.",
    refreshInvoice: "Odśwież status",
    retryIssuance: "Sprawdź ponownie",
    issuanceAlreadyInProgressError: "Wystawianie faktury nadal trwa",
    issuanceAlreadyInProgressDetail: "Odśwież status za chwilę. Nie uruchamiaj kolejnej próby, dopóki poprzednia nie zostanie zakończona.",
    issuanceResetError: "Wystawianie faktury zostało bezpiecznie zresetowane",
    issuanceResetDetail: "Faktura wróciła do szkicu. Sprawdź dane i uruchom wystawianie ponownie.",
    issuanceArtifactRecoveryError: "Nie można bezpiecznie wznowić wystawiania",
    issuanceArtifactRecoveryDetail: "Brakuje poprawnych plików faktury. Nie oznaczaj jej ręcznie jako wystawionej — wymagane jest odzyskanie artefaktów po stronie serwera.",
  ...
  invoiceDetail: {
    ...
    issuingTitle: "Wystawianie faktury",
